...
const Navbar = () => {
  return (
    <div className="fixed w-full h-24 shadow-xl text-white">
      <div className="flex justify-between px-20 items-center h-full w-full 2xl:px-16">
        ...
        <div>
          <ul className="hidden sm:flex">
            <Link href="/features">
              <li className="ml-10 text-xl font-lilita">Features</li>
            </Link>
            <Link href="/about">
              <li className="ml-10 text-xl font-lilita">About</li>
            </Link>
            <Link href="/blogs">
              <li className="ml-10 text-xl font-lilita">Blogs</li>
            </Link>
          </ul>
        </div>
        {/* Right */}
